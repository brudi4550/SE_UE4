...
public class AnalyzerFunctionFactory {
     ...
     */
    public static Function<List<LearningZone>, Integer> getCountFunction(Content c) throws IllegalArgumentException {
        if(c == null)
     ...
     * @throws IllegalArgumentException If the Content value is not Timeable or null.
     * @return Function object
     */
